...
app.get("/movienamesearch", (req, res) => {
    ...
    var url;
    if(moviename){
        url = "https://api.themoviedb.org/3/search/movie?api_key=25ccc821ed61e1ada0531dc00722e6e8&query="+moviename;
    }
    else{
      url="https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=25ccc821ed61e1ada0531dc00722e6e8";
    }
